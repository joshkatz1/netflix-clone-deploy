...
const Navbar = () => {
  ...
  return (
      <nav className='w-full fixed z-40 '>
          <div className={ `flex flex-row  items-center px-4 py-6 md:px-16
           transition duration-500  ${showBackground ? 'bg-zinc-900 bg-opacity-90' :''}` }>
              <img src='/images/logo.png' alt='logo' className="h-4 lg:h-7" />
              <div className=' flex-row items-center ml-8 gap-7 hidden lg:flex '>
              ...
              <div onClick={toggleMobileMenu} className='lg:hidden flex flex-row items-center gap-2 ml-8 relative' >
                  <p className='items-center text-white text-sm '>Browse</p>
              ...
              <div className='flex flex-row ml-auto gap-7 items-center '>
                  ...
                  <div onClick={toggleAccountMenu} className='flex flex-row items-center gap-2 cursor-pointer relative' >
                      <div className='w-6 w-h lg:w-10 lg:h-10 rounded-md overflow-hidden'>
